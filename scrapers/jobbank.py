    ...
    if response.status_code == 200:
        ...
        for job in jobs:
            try:
                ...
                job_id = insert_job(title, company_id, location, salary_range, date_posted, link, is_remote, experience_required)
...
if __name__ == "__main__":
    num_jobs = scrape_jobbank()
    print(f"Successfully processed {num_jobs} jobs")